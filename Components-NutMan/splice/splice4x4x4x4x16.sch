...
<drawing version="7">
    ...
    <netlist>
        ...
        <port polarity="Input" name="H(3:0)" />
        <blockdef name="buf">
        ...
        <block symbolname="buf" name="XLXI_7">
            <blockpin signalname="M(2)" name="I" />
            <blockpin signalname="O(6)" name="O" />
        </block>
        <block symbolname="buf" name="XLXI_8">
            <blockpin signalname="M(3)" name="I" />
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <branch name="L(3:0)">
            ...
            <wire x2="320" y1="320" y2="336" x1="320" />
        ...
        <iomarker fontsize="28" x="272" y="800" name="Q(3:0)" orien="R180" />
        <iomarker fontsize="28" x="272" y="160" name="L(3:0)" orien="R180" />
        <iomarker fontsize="28" x="1120" y="160" name="O(15:0)" orien="R0" />
        <iomarker fontsize="28" x="272" y="480" name="M(3:0)" orien="R180" />
        <branch name="M(3:0)">
            <wire x2="320" y1="480" y2="480" x1="272" />
            <wire x2="320" y1="480" y2="560" x1="320" />
            <wire x2="320" y1="560" y2="640" x1="320" />
            <wire x2="320" y1="640" y2="720" x1="320" />
        </branch>
        <iomarker fontsize="28" x="272" y="1120" name="H(3:0)" orien="R180" />
        <branch name="H(3:0)">
