...
<drawing version="7">
    ...
    <sheet sheetnum="1" width="1900" height="1344">
        ...
        <branch name="Count(3)">
            <wire x2="752" y1="400" y2="400" x1="96" />
            <wire x2="752" y1="400" y2="720" x1="752" />
            <wire x2="768" y1="720" y2="720" x1="752" />
            <wire x2="96" y1="400" y2="928" x1="96" />
            <wire x2="752" y1="720" y2="720" x1="480" />
        </branch>
        <branch name="Count(0)">
            <wire x2="160" y1="416" y2="928" x1="160" />
            <wire x2="704" y1="416" y2="416" x1="160" />
            <wire x2="704" y1="416" y2="528" x1="704" />
            <wire x2="768" y1="528" y2="528" x1="704" />
            <wire x2="704" y1="528" y2="528" x1="480" />
        </branch>
        <branch name="Count(2)">
            <wire x2="224" y1="432" y2="928" x1="224" />
            <wire x2="736" y1="432" y2="432" x1="224" />
            <wire x2="736" y1="432" y2="656" x1="736" />
            <wire x2="768" y1="656" y2="656" x1="736" />
            <wire x2="736" y1="656" y2="656" x1="480" />
        </branch>
        <branch name="Count(1)">
            <wire x2="720" y1="448" y2="448" x1="288" />
            <wire x2="720" y1="448" y2="592" x1="720" />
            <wire x2="768" y1="592" y2="592" x1="720" />
            <wire x2="288" y1="448" y2="928" x1="288" />
